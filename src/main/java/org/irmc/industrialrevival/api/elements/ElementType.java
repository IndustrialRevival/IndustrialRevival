...
public enum ElementType {
    ...
    RUTHERFORDIUM("Rf", 261, 104, Valence.of(4), true, ElementGroup.IVB, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    DUBNIUM("Db", 262, 105, Valence.of(5), true, ElementGroup.VB, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    SEABORGIUM("Sg", 263, 106, Valence.of(6), true, ElementGroup.VIB, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    BOHRIUM("Bh", 264, 107, Valence.of(7), true, ElementGroup.VIIB, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    HASSIUM("Hs", 265, 108, Valence.of(8), true, ElementGroup.VIII, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    MEITNERIUM("Mt", 266, 109, Valence.of(0), true, ElementGroup.VIII, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    DARMSTADTIUM("Ds", 269, 110, Valence.of(0), true, ElementGroup.VIII, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    ROENTGENIUM("Rg", 272, 111, Valence.of(0), true, ElementGroup.IB, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    COPERNICIUM("Cn", 277, 112, Valence.of(0), true, ElementGroup.IIB, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    NIHONIUM("Nh", 286, 113, Valence.of(3, 1), true, ElementGroup.IIIA, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    FLEROVIUM("Fl", 289, 114, Valence.of(3, 0), true, ElementGroup.IVA, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    MOSCOVIUM("Mc", 289, 115, Valence.of(1, 3), true, ElementGroup.VA, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    LIVERMORIUM("Lv", 293, 116, Valence.of(4), true, ElementGroup.VIA, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    TENNESSINE("Ts", 294, 117, Valence.of(-1), false, ElementGroup.VIIA, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN),
    OGANESSON("Og", 294, 118, Valence.of(0), false, ElementGroup.O, 7, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN, ElementUtil.UNKNOWN);
