...
public abstract class StructurePiece {
    ...
    public static final Map<NamespacedKey, StructurePiece> IR_CACHE = new HashMap<>();
    ...
    static StructurePiece getByIRItem(IndustrialRevivalItem iritem) {
        return IR_CACHE.computeIfAbsent(iritem.getId(), _ -> new IRBlockStructurePiece(iritem));
    }
