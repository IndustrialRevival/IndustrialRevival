...
public class IRItemGroups {
    ...
    public static final ItemGroup MANUAL_MACHINES =
            new NormalItemGroup(Keys.customKey("manual_machines"), GroupIcons.GROUP_MANUAL_MACHINES);
    public static final ItemGroup MATERIALS =
            new NormalItemGroup(Keys.customKey("materials"), GroupIcons.GROUP_MATERIALS);
    ...
    public static final ItemGroup ELECTRIC_MACHINES =
            new NormalItemGroup(Keys.customKey("electric_machines"), GroupIcons.GROUP_ELECTRIC_MACHINES);
