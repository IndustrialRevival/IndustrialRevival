...
public class IRRecipes {
    ...
    public static final ItemStack[] LAVA_ALLOY = new ItemStack[] {
            new ItemStack(Material.MAGMA_BLOCK), new ItemStack(Material.IRON_NUGGET), null,
            new ItemStack(Material.IRON_NUGGET), new ItemStack(Material.MAGMA_BLOCK), null,
            null, null, null
    };
    public static final ItemStack[] ROCK_IRON_ALLOY = new ItemStack[] {
            new ItemStack(Material.STONE), new ItemStack(Material.IRON_NUGGET), null,
            new ItemStack(Material.IRON_NUGGET), new ItemStack(Material.STONE), null,
            null, null, null
    };
    public static final ItemStack[] ALUMINIUM_ALLOY = new ItemStack[] {
            IRItemStacks.ALUMINIUM, IRItemStacks.FINE_IRON, IRItemStacks.MAGNESIUM,
            null, null, null, null, null, null
    };      //Output: Item x 3
    public static final ItemStack[] COPPER_NICKEL_ALLOY = new ItemStack[] {
            ItemUtils.cloneItem(IRItemStacks.NICKEL, 2), new ItemStack(Material.COPPER_INGOT), null,
            null, null, null,
            null, null, null
    };      //Output: Item x 3
    public static final ItemStack[] NICHROM = new ItemStack[] {
            ItemUtils.cloneItem(IRItemStacks.NICKEL, 4), IRItemStacks.CHROMIUM, null,
            null, null, null,
            null, null, null
    };      //Output: Item x 5
    public static final ItemStack[] SILICON_STEEL = new ItemStack[] {
            ItemUtils.cloneItem(IRItemStacks.FINE_IRON, 2), IRItemStacks.SILICON, null,
            null, null, null,
            null, null, null
    };      //Output: Item x 2
    public static final ItemStack[] WOLFRAM_STEEL = new ItemStack[] {
            ItemUtils.cloneItem(IRItemStacks.CHROMIUM, 3), ItemUtils.cloneItem(IRItemStacks.NICKEL, 3), ItemUtils.cloneItem(IRItemStacks.COBALT, 3),
            IRItemStacks.TUNGSTEN, null, null,
            null, null, null
    };      //Output: Item x 10
    ...
    public static final ItemStack[] SLAG = new ItemStack[] {
            null, null, null,
            null, new CustomItemStack(Material.PAPER, "Appear Randomly In Smelting"), null,
            null, null, null
    };
    public static final ItemStack[] BRASS = new ItemStack[] {
            ItemUtils.cloneItem(IRItemStacks.ZINC, 2), new ItemStack(Material.COPPER_INGOT), null,
            null, null, null,
            null, null, null
    };      //Output: Item x 3
    public static final ItemStack[] FINE_IRON = new ItemStack[] {
            ItemUtils.cloneItem(Material.IRON_INGOT, 4), null, null,
            null, null, null,
            null, null, null
    };
    public static final ItemStack[] FINE_GOLD = new ItemStack[] {
            ItemUtils.cloneItem(Material.GOLD_INGOT, 8), null, null,
            null, null, null,
            null, null, null
    };
    public static final ItemStack[] TUNGSTEN = new ItemStack[] {
            IRItemStacks.TUNGSTEN_ORE, null, null,
            null, null, null,
            null, null, null
    };
    public static final ItemStack[] SLIVER = new ItemStack[] {
            IRItemStacks.SLIVER_ORE, null, null,
            null, null, null,
            null, null, null
    };
    public static final ItemStack[] NICKEL = new ItemStack[] {
            IRItemStacks.NICKEL_ORE, null, null,
            null, null, null,
            null, null, null
    };
    public static final ItemStack[] COBALT = new ItemStack[] {
            IRItemStacks.COBALT_ORE, null, null,
            null, null, null,
            null, null, null
    };
    public static final ItemStack[] CHROMIUM = new ItemStack[] {
            IRItemStacks.CHROMIUM_ORE, null, null,
            null, null, null,
            null, null, null
    };
    public static final ItemStack[] MAGNET = new ItemStack[] {
            IRItemStacks.MAGNET_ORE, null, null,
            null, null, null,
            null, null, null
    };
    public static final ItemStack[] URANIUM = new ItemStack[] {
            IRItemStacks.URANIUM_ORE, null, null,
            null, null, null,
            null, null, null
    };
    public static final ItemStack[] ALUMINIUM = new ItemStack[] {
            IRItemStacks.ALUMINIUM_ORE, null, null,
            null, null, null,
            null, null, null
    };
    public static final ItemStack[] TIN = new ItemStack[] {
            IRItemStacks.TIN_ORE, null, null,
            null, null, null,
            null, null, null
    };
    public static final ItemStack[] MAGNESIUM = new ItemStack[] {
            IRItemStacks.MAGNESIUM_ORE, null, null,
            null, null, null,
            null, null, null
    };
    public static final ItemStack[] LEAD = new ItemStack[] {
            IRItemStacks.LEAD_ORE, null, null,
            null, null, null,
            null, null, null
    };
    public static final ItemStack[] ZINC = new ItemStack[] {
            IRItemStacks.ZINC_ORE, null, null,
            null, null, null,
            null, null, null
    };
}
